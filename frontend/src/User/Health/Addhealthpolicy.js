...
function  Addhealthpolicy() {
  ...
  const handleSubmit = async (e) => {
    ...
    //   const gst = price / 5 + +price; // Calculate GST (8%)
      ...
      await axios.post('http://localhost:8080/userhealth', updatedFormData);
    ...
    <div  style={{backgroundColor:"#F8F9FA",}}>
     ...
     <div style={{ display: 'flex ' }} >
        <div className="max-w-md mx-auto mt-8 p-4 border rounded shadow-lg bg-white">
          <h2 className="text-2xl font-semibold" >Your Health is almost insured! </h2>
